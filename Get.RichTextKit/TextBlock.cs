...
namespace Get.RichTextKit
{
    ...
    public class TextBlock : StyledText
    {
        ...
        class UnshapedRun
        {
            ...
            {
                return
                    !(styleRun.Style is IDoNotCombineStyle) &&
                    !(next.styleRun.Style is IDoNotCombineStyle) &&
...
//                    frIndex = frIndexStartOfLine;
                    ...
                    while (codePointIndexWrap < _codePoints.Length && UnicodeClasses.LineBreakClass(_codePoints[codePointIndexWrap]) == LineBreakClass.SP && !(fr.Style is ICustomRenderSizeStyle))
                        codePointIndexWrap++;
                }
