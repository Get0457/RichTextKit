...
namespace Get.RichTextKit.Utils
{
    ...
    public class Utf32Buffer : Buffer<int>
    {
        ...
        /// </summary>
        /// <param name="str">The string to initialize with</param>
        public Utf32Buffer(ReadOnlySpan<char> str)
        {
            Add(str);
        }
        ...
        /// </summary>
        /// <param name="str">The string to initialize with</param>
        public Utf32Buffer(ReadOnlySpan<int> str)
        {
            Add(str);
        }
        ...
        /// <param name="str">The string of text to be inserted</param>
        /// <returns>A slice representing the added UTF-32 data.</returns>
        public Slice<int> Add(ReadOnlySpan<int> str)
        {
            return Add(new Slice<int>(str.ToArray()));
        }
